...
L_interrupt20:
	...
	GOTO       L_interrupt25
	MOVLW      2
	MOVWF      ?FLOC___interruptT27+0
	GOTO       L_interrupt26
L_interrupt25:
	CLRF       ?FLOC___interruptT27+0
L_interrupt26:
	MOVF       ?FLOC___interruptT27+0, 0
	MOVWF      _manual_state+0
L_interrupt24:
L_interrupt19:
	BTFSC      RE0_bit+0, BitPos(RE0_bit+0)
...
_main:
	...
	GOTO       L_main63
	MOVLW      2
	MOVWF      ?FLOC___mainT62+0
	GOTO       L_main64
L_main63:
	CLRF       ?FLOC___mainT62+0
L_main64:
	MOVF       ?FLOC___mainT62+0, 0
	MOVWF      _manual_state+0
