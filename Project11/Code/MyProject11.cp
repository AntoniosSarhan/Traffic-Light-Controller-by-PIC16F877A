#line 1 "C:/Users/Antonios/Desktop/Summer Training/Embedded Systems/Embedded/Project11/Code/MyProject11.c"
#line 22 "C:/Users/Antonios/Desktop/Summer Training/Embedded Systems/Embedded/Project11/Code/MyProject11.c"
...
void interrupt() {
 ...
 exiting_manual = 0;
 manual_state = ( RE1_bit  == 0) ? 2 : 0;
 }
 }

 if ( RE0_bit  == 0) {
 if (manual_state == 0 &&  RE1_bit  == 0) { manual_state = 1; west_timer = 3; }
 else if (manual_state == 2 &&  RE1_bit  == 1) { manual_state = 3; south_timer = 3; }
 }
